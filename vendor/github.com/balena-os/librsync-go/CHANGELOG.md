...
* rename readCount and fix buffer reading [Yann CARDAILLAC]
* bufferize signature output [Alexis Auriac]
* delta: read more than 1 byte when possible [Alexis Auriac]
