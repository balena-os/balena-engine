...
const (
	...
	// balenaEngine daemon by default always listens on the default unix socket
	defaultUnixSocket = "/var/run/balena-engine.sock"
	// defaultTCPHost constant defines the default host string used by balena on Windows
	defaultTCPHost = "tcp://" + defaultHTTPHost + ":" + defaultHTTPPort
	// DefaultTLSHost constant defines the default host string used by balena for TLS sockets
	defaultTLSHost = "tcp://" + defaultHTTPHost + ":" + defaultTLSHTTPPort
	// DefaultNamedPipe defines the default named pipe used by balena on Windows
	defaultNamedPipe = `//./pipe/balena_engine`
