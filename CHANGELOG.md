...
* Remove TODO about error handling [Leandro Motta Barros]
* Remove TODO about tagging [Leandro Motta Barros]
* Don't try to delta-load an image if it already exists [Leandro Motta Barros]
* Add integration test for `image load`ing a delta [Leandro Motta Barros]
* Use the delta image store with the `image load` command [Leandro Motta Barros]
* Initial PoC for "delta on load" [Leandro Motta Barros]
* Add upstream changelog [Leandro Motta Barros]

# v20.10.22

## (2022-11-22) [upstream release]
