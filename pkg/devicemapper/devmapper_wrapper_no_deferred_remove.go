//go:build linux && cgo && !libdm_dlsym_deferred_remove && libdm_no_deferred_remove && !no_devmapper
// +build linux,cgo,!libdm_dlsym_deferred_remove,libdm_no_deferred_remove,!no_devmapper
