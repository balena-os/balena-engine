...
branches=(
    "v20.10.33"                # Before power-of-two improvement
    "master"                   # After power-of-two
    "lmb/fix-concat-reader"    # Small fix, may reduce delta size a bit, ready to merge
    "v20.10.36"                # Right before lmb/optimize-deltas
    "lmb/optimize-deltas"      # [WIP] The final version of the delta optimization
)
